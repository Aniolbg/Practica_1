...
\*\*2. Valor medio de la columna Bytes\*`{r} data_bytes <- data$bytes data_bytes[data_bytes == "-"] <- NA data_bytes <- as.numeric(data_bytes) medio <- mean(data_bytes, na.rm = TRUE) cat(sprintf("El valor medio de la columna bytes es %.2f", medio))`
